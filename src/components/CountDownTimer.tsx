    ...
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-200">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600">
          Your memory will be revealed soon
        </p>
      </div>

      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white rounded-xl p-2 shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
          <div className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent inline-block w-fit mb-1">
            {days}
          </div>
          <div className="text-xs font-semibold text-gray-600 uppercase text-center">
            Days
          </div>
        </div>
