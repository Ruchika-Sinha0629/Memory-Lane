...
export default function CapsuleForm({ userId }: CapsuleFormProps) {
  ...
  const [privacy, setPrivacy] =
    useState<"private" | "collaborators" | "public">("private");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-12 px-6">
      ...
      <div className="relative max-w-4xl mx-auto">
        <form onSubmit={handleSubmit} className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 space-y-6">
          {/* Header */}
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Preserve your precious moments for the future</p>
          </div>
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white/80 text-gray-500 font-medium">AI Enhancement (Optional)</span>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 p-6 rounded-xl space-y-4">
              ...
              {caption && (
                <div>
                  ...
                  <p className="text-gray-700 bg-white p-3 rounded-lg">{caption}</p>
                </div>
              )}
              ...
              {summary && (
                <div>
                  ...
                  <p className="text-gray-700 bg-white p-3 rounded-lg">{summary}</p>
                </div>
              )}
            </div>
          )}
