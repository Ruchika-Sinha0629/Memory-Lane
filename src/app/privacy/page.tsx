        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-8 space-y-8">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              At MemoryLane, we take your privacy seriously. This Privacy Policy
              explains how we collect, use, and protect your personal
              information when you use our time capsule platform. Your memories
              are precious, and we're committed to keeping them safe and secure.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-pink-50 rounded-xl p-4 border-2 border-pink-200">
                ...
                <p className="text-gray-700">
                  Photos, videos, audio files, and text you upload to create
                  memory capsules are stored securely on our servers.
                </p>
              </div>
              <div className="bg-indigo-50 rounded-xl p-4 border-2 border-indigo-200">
                ...
                <p className="text-gray-700">
                  We collect information about how you use MemoryLane, including
                  capsule creation dates, unlock dates, and feature usage.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-700">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  To generate AI-powered captions and summaries (only when
                  requested)
                </span>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border-2 border-purple-200">
                <p className="text-gray-700">
                  <strong className="text-purple-700">Encryption:</strong> All
                  data is encrypted in transit and at rest
                </p>
              </div>
              <div className="bg-gradient-to-br from-pink-50 to-indigo-50 rounded-xl p-4 border-2 border-pink-200">
                <p className="text-gray-700">
                  <strong className="text-pink-700">Secure Storage:</strong>{" "}
                  Files are stored on secure cloud infrastructure
                </p>
              </div>
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4 border-2 border-indigo-200">
                <p className="text-gray-700">
                  <strong className="text-indigo-700">Access Controls:</strong>{" "}
                  Strict authentication and authorization
                </p>
              </div>
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border-2 border-purple-200">
                <p className="text-gray-700">
                  <strong className="text-purple-700">Regular Audits:</strong>{" "}
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start gap-2">
                <span className="text-purple-600 font-bold">•</span>
                <span>
                  Edit or delete your memory capsules before they unlock
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-600 font-bold">•</span>
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                We only share data with service providers who help us operate
                the platform (e.g., cloud storage, email delivery) and who are
                bound by strict confidentiality agreements. Your memories remain
                yours.
              </p>
            </div>
          </div>
