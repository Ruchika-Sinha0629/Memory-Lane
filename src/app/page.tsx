        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 sm:py-32">
          <div className="text-center space-y-8">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Create digital time capsules that unlock emotions at the right
              moment. Store memories, share with loved ones, and let your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Set your memories to unlock on special dates or life milestones.
                Create anticipation for the perfect moment.
              </p>
            </div>
            ...
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Invite loved ones to contribute their memories and stories to
                shared capsules together.
              </p>
            </div>
            ...
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Store photos, videos, audio messages, and heartfelt letters all
            ...
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Connect capsules to graduations, weddings, birthdays, or any
            ...
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Automatic email reminders when capsules unlock, so no precious
                memory goes unnoticed.
              </p>
            </div>
            ...
            <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Organize memories into beautiful themes like Childhood, Family
                History, or College Years.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative py-20 px-6">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 rounded-3xl p-12 shadow-2xl">
          ...
          <p className="text-lg text-purple-100 mb-8 max-w-2xl mx-auto">
            Join thousands of families preserving their most precious moments
